...
#line 38 "src\\\\auto\\\\XSTools\\\\PaddedPackets\\\\PaddedPackets.xs"
	...
	engine.addKey(7);
	RETVAL = engine.encode((byte *) packet, sitPacketID);
#line 218 "src\\auto\\XSTools\\PaddedPackets\\PaddedPackets.c"
	XSprePUSH;
	PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
...
#line 248 "src\\auto\\XSTools\\PaddedPackets\\PaddedPackets.c"
	XSprePUSH;
	PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
...
#line 267 "src\\auto\\XSTools\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 69 "src\\\\auto\\\\XSTools\\\\PaddedPackets\\\\PaddedPackets.xs"
	engine.setSync(sync);
#line 284 "src\\auto\\XSTools\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 301 "src\\auto\\XSTools\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 323 "src\\auto\\XSTools\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 91 "src\\\\auto\\\\XSTools\\\\PaddedPackets\\\\PaddedPackets.xs"
	sitPacketID = sit;
	skillPacketID = skill;
#line 343 "src\\auto\\XSTools\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 362 "src\\auto\\XSTools\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 381 "src\\auto\\XSTools\\PaddedPackets\\PaddedPackets.c"
	XSprePUSH;
	PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
