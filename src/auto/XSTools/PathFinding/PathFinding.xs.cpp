...
#line 433 "src\\\\auto\\\\XSTools\\\\PathFinding\\\\PathFinding.xs"
		int status;
#line 662 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
	int	RETVAL;
	dXSTARG;
...
#line 681 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
	XSprePUSH;
	PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
...
#line 699 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
...
#line 710 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
#line 748 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
	XSprePUSH;
	PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
...
#line 794 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
	XSprePUSH;
	PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
...
#line 846 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
	XSprePUSH;
	PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
...
#line 971 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
#line 1015 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
	XSprePUSH;
	PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
...
#line 1060 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
#line 1091 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
	XSprePUSH;
	PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
...
#line 1124 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
	XSprePUSH;
	PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
...
#line 1205 "src\\auto\\XSTools\\PathFinding\\PathFinding.c"
	XSprePUSH;
	PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
