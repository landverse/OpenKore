...
#line 30 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		char *op = NULL;
#line 224 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 229 "src\\auto\\XSTools\\win32\\wrapper.c"
	XSprePUSH;
	PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
...
#line 41 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		HANDLE toolhelp;
		PROCESSENTRY32 pe;
#line 249 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 268 "src\\auto\\XSTools\\win32\\wrapper.c"
	PUTBACK;
	return;
    }
}
...
#line 287 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 305 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 326 "src\\auto\\XSTools\\win32\\wrapper.c"
	XSprePUSH;
	PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
...
#line 349 "src\\auto\\XSTools\\win32\\wrapper.c"
	XSprePUSH;
	PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
...
#line 372 "src\\auto\\XSTools\\win32\\wrapper.c"
	XSprePUSH;
	PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
...
#line 429 "src\\auto\\XSTools\\win32\\wrapper.c"
	XSprePUSH;
	PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
...
#line 138 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		DWORD bytesRead;
		LPVOID buffer;
#line 454 "src\\auto\\XSTools\\win32\\wrapper.c"
#line 141 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		...
		free(buffer);
#line 463 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 157 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		...
		STRLEN dwSize;
		DWORD bytesWritten;
#line 490 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 502 "src\\auto\\XSTools\\win32\\wrapper.c"
	XSprePUSH;
	PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
...
#line 521 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 564 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 588 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 624 "src\\auto\\XSTools\\win32\\wrapper.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 661 "src\\auto\\XSTools\\win32\\wrapper.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 263 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
	WCHAR buffer[1024];
	DWORD size;
#line 682 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 699 "src\\auto\\XSTools\\win32\\wrapper.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
